...
Community discussion happens in [#flatpak on Freenode](irc://freenode.net:6697/flatpak) and on [the mailing list](https://lists.freedesktop.org/mailman/listinfo/flatpak).
