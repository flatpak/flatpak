# Flatpak 1.12.x: end-of-life branch

The Flatpak 1.12.x branch is no longer supported and does not receive
security fixes.
...
distributing Flatpak 1.12.x, those vendors will need to either take
