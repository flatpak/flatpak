...
$FLATPAK build-commit-from  --no-update-summary ${FL_GPGARGS} ${FL_SIGNARGS} --token-type=2 --disable-fsync --src-ref=app/org.test.Hello/$ARCH/master repos/test app/org.test.Hello/$ARCH/copy >&2
update_repo
