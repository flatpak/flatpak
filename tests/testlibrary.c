...
test_delete_app_data (void)
{
  ...
  g_assert_true (flatpak_user_data_delete ("org.test.AppData", NULL, &error));
  g_assert_no_error (error);
  ...
  g_assert_false (flatpak_user_data_delete ("org.test.AppData", cancellable,
                                            &error));
  g_assert_error (error, G_IO_ERROR, G_IO_ERROR_CANCELLED);
  g_assert_true (g_file_test (app_dir, G_FILE_TEST_IS_DIR));
  g_clear_error (&error);

  g_assert_false (flatpak_user_data_delete ("org.test.Missing", cancellable,
                                            &error));
  g_assert_error (error, G_IO_ERROR, G_IO_ERROR_CANCELLED);
  g_clear_error (&error);
  ...
  g_assert_false (flatpak_user_data_delete ("../outside", NULL, &error));
  ...
  g_assert_no_error (error);
  g_assert_false (flatpak_user_data_delete ("org.test.AppData", NULL, &error));
